...
- [x] Реализация запросов и обработок данных для команд бота
- [x] Создание и тестирование команд /start и /help
- [x] Реализация дополнительных команд
- [x] Реализация команды /history
